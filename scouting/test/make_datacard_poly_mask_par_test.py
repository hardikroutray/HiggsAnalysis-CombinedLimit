...
xfitup = h3.GetBinCenter(h3.GetXaxis().FindBin(mu + 9*sig)) + float(binwidth/2.0)
xfitdown = h3.GetBinCenter(h3.GetXaxis().FindBin(mu - 9*sig)) - float(binwidth/2.0)
...
############################################################################################################
	...
	# p0 =  ROOT.RooRealVar("p0","p0",1,-10000000,10000000)
        ...
        # p0 =  ROOT.RooRealVar("p0","p0",0.05,-1,1)
        # p1 =  ROOT.RooRealVar("p1","p1",0.05,-1,1)
        # p2 =  ROOT.RooRealVar("p2","p2",0.2,-1,1)
        # p3 =  ROOT.RooRealVar("p3","p3",0.2,-1,1)
        # p4 =  ROOT.RooRealVar("p4","p4",0.5,-1,1)
        # p5 =  ROOT.RooRealVar("p5","p5",0.5,-1,1)
        # p6 =  ROOT.RooRealVar("p6","p6",0.5,0,1)
        # p7 = ROOT.RooRealVar("p7","p7",0.5,0,1)
        # p8 = ROOT.RooRealVar("p8","p8",0.5,0,1)
        # p9 = ROOT.RooRealVar("p9","p9",0.5,0,1)


        # p0 = ROOT.RooRealVar("p0","p0",-50,400)
        # p1 = ROOT.RooRealVar("p1","p1",-50,400)
        # p2 = ROOT.RooRealVar("p2","p2",-500,1000)
        # p3 = ROOT.RooRealVar("p3","p3",-50,1000)
        # p4 = ROOT.RooRealVar("p4","p4",-50,100)
        # p5 = ROOT.RooRealVar("p5","p5",-50,100)
        # p6 = ROOT.RooRealVar("p6","p6",-50,100)
        # p7 = ROOT.RooRealVar("p7","p7",-50,100)
        # p8 = ROOT.RooRealVar("p8","p8",-50,100)


        p0 = ROOT.RooRealVar("p0","p0",-1,10)
        p1 = ROOT.RooRealVar("p1","p1",-1,10)
        p2 = ROOT.RooRealVar("p2","p2",-1,10)
        p3 = ROOT.RooRealVar("p3","p3",-1,10)
        # p4 = ROOT.RooRealVar("p4","p4",0,10)
        # p5 = ROOT.RooRealVar("p5","p5",0,10)
        # p6 = ROOT.RooRealVar("p6","p6",0,10)
        # p7 = ROOT.RooRealVar("p7","p7",-10,10)
        # p8 = ROOT.RooRealVar("p8","p8",-10,10)
	...
	# background = ROOT.RooChebychev("background","background", x, ROOT.RooArgList(p0,p1,p2,p3,p4,p5))
	...
	result = ROOT.RooFitResult(background.fitTo(data_obs, ROOT.RooFit.Range("R1,R2"), ROOT.RooFit.NormRange("R1,R2"), ROOT.RooFit.Save(ROOT.kTRUE), ROOT.RooFit.Minimizer("Minuit2","Migrad"))) 
        background.fitTo(data_obs, ROOT.RooFit.Range("R1,R2"), ROOT.RooFit.NormRange("R1,R2"))
	...
	# model.plotOn(xframe,ROOT.RooFit.VisualizeError(result,1,ROOT.kFALSE), ROOT.RooFit.DrawOption("F"), ROOT.RooFit.Components(bkg_component), ROOT.RooFit.Name("errorband"), ROOT.RooFit.FillColor(ROOT.kOrange), ROOT.RooFit.Range("Full"), ROOT.RooFit.NormRange("Full"))
        background.plotOn(xframe,ROOT.RooFit.VisualizeError(result,1,ROOT.kFALSE), ROOT.RooFit.DrawOption("F"), ROOT.RooFit.Name("errorband"), ROOT.RooFit.FillColor(ROOT.kOrange), ROOT.RooFit.Range("Full"), ROOT.RooFit.NormRange("Full"))
        # background.plotOn(xframe,ROOT.RooFit.VisualizeError(result,1), ROOT.RooFit.Name("errorband"), ROOT.RooFit.FillColor(ROOT.kOrange), ROOT.RooFit.Range("Full"), ROOT.RooFit.NormRange("Full"))
        # data_obs.plotOn(xframe, ROOT.RooFit.Name("data"))
        # model.plotOn(xframe,ROOT.RooFit.LineColor(3),ROOT.RooFit.Components(bkg_component), ROOT.RooFit.Name("bkg"), ROOT.RooFit.LineStyle(2), ROOT.RooFit.Range("Full"), ROOT.RooFit.NormRange("Full"))
        background.plotOn(xframe,ROOT.RooFit.LineColor(3),ROOT.RooFit.Name("bkg"), ROOT.RooFit.LineStyle(2), ROOT.RooFit.Range("Full"), ROOT.RooFit.NormRange("Full"))
	...
	leg1.AddEntry(xframe.findObject("errorband"), "Fit Error", "")
        ...
        c1.BuildLegend()
        c1.Draw()
        c1.SaveAs("testmass{}_lxy{}_{}_poly_test.png".format(mass, lxybins[j,0], lxybins[j,1]))
        ...
        background.plotOn(xframe2,ROOT.RooFit.LineColor(3), ROOT.RooFit.LineStyle(2), ROOT.RooFit.Name("bkg"), ROOT.RooFit.Range("Full"), ROOT.RooFit.NormRange("Full"))
	# model.plotOn(xframe2,ROOT.RooFit.VisualizeError(result,1,ROOT.kFALSE), ROOT.RooFit.DrawOption("F"), ROOT.RooFit.Components(bkg_component), ROOT.RooFit.Name("errorband"), ROOT.RooFit.FillColor(ROOT.kOrange), ROOT.RooFit.Range("Full"), ROOT.RooFit.NormRange("Full"))
        background.plotOn(xframe2,ROOT.RooFit.VisualizeError(result,1,ROOT.kFALSE), ROOT.RooFit.DrawOption("F"), ROOT.RooFit.Name("errorband"), ROOT.RooFit.FillColor(ROOT.kOrange), ROOT.RooFit.Range("Full"), ROOT.RooFit.NormRange("Full"))
        # data_obs.plotOn(xframe2, ROOT.RooFit.Name("data"))
        ...
        background.plotOn(xframe2,ROOT.RooFit.LineColor(2), ROOT.RooFit.Name("bkg"), ROOT.RooFit.LineStyle(1), ROOT.RooFit.Range("Full"), ROOT.RooFit.NormRange("Full"))

        xframe2.Draw()
        xframe2.GetYaxis().SetRangeUser(500,700)                                                                                                                                                       
	...
	box.Draw()
        ...
        # c2.BuildLegend()
        c2.Draw()
        c2.SaveAs("mass{}_lxy{}_{}_poly_test.png".format(mass, lxybins[j,0], lxybins[j,1]))
