...
############################################################################################################
	...
	# p0 =  ROOT.RooRealVar("p0","p0",1,-10000000,10000000)
        ...
        p0 =  ROOT.RooRealVar("p0","p0",0.001,-1,1)                                                                                                                                                      
        p1 =  ROOT.RooRealVar("p1","p1",0.001,-1,1)                                                                                                                                                      
        p2 =  ROOT.RooRealVar("p2","p2",0.001,-1,1)                                                                                                                                                      
        p3 =  ROOT.RooRealVar("p3","p3",0.001,-1,1)                                                                                                                                                      
        p4 =  ROOT.RooRealVar("p4","p4",0.001,-1,1)                                                                                                                                                      
        p5 =  ROOT.RooRealVar("p5","p5",0.001,-1,1)                                                                                                                                                      
        p6 =  ROOT.RooRealVar("p6","p6",0.001,-1,1)                                                                                                                                                     
        p7 = ROOT.RooRealVar("p7","p7",0.001,-1,1)                                                                                                                                                         
        p8 = ROOT.RooRealVar("p8","p8",0.001,-1,1)    


        # p0 = ROOT.RooRealVar("p0","p0",-5,5)                                                                                                                                                       
        # p1 = ROOT.RooRealVar("p1","p1",-5,5)                                                                                                                                                       
        # p2 = ROOT.RooRealVar("p2","p2",-5,5)                                                                                                                                                       
        # p3 = ROOT.RooRealVar("p3","p3",-5,5)                                                                                                                                                     
        # p4 = ROOT.RooRealVar("p4","p4",-5,5)                                                                                                                                                          
        # p5 = ROOT.RooRealVar("p5","p5",-5,5)                                                                                                                                                          
        # p6 = ROOT.RooRealVar("p6","p6",-5,5)                                                                                                                                                          
        # p7 = ROOT.RooRealVar("p7","p7",1,10000)                                                                                                                                                          
        # p8 = ROOT.RooRealVar("p8","p8",1,10000)      
	...
	background = ROOT.RooBernstein("background","background", x, ROOT.RooArgList(p0,p1,p2,p3,p4,p5,p6,p7,p8))

	nB = data.Integral()
	# background_norm = ROOT.RooRealVar("background_norm","background_norm",nB,0.9*nB,1.1*nB)
        result = ROOT.RooFitResult(background.fitTo(data_obs, ROOT.RooFit.Range("R1,R2"), ROOT.RooFit.NormRange("R1,R2"), ROOT.RooFit.Save(ROOT.kTRUE)))
